...
export default function Services() {
  ...
  return (
    <section id="services" className="max-w-6xl mx-auto grid md:grid-cols-2 min-h-[42rem] my-10">
      <div className="bg-peach px-10 md:px-16 py-16 flex flex-col justify-between">
        <div>
          ...
          <div className="flex gap-2 mb-16">
            {services.map((s, i) => (
              <button
                ...
                aria-label={s.title}
              >
                <CornerDot className={i === active ? "text-burnt" : "text-dark/40"} />
              </button>
            ))}
          </div>
          ...
          <hr className="border-dashed border-dark/30 mb-6" />
